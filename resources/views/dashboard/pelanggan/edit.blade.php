                    ...
                    <form method="POST" action="{{ route('pelanggan.update', $pelanggan->id) }}">
                        ...
                        <div class="mb-3 mt-4 row">
                            ...
                            <select class="form-select @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" id="jenis_kelamin" aria-label="Default select example">
                                    <option @if(old('jenis_kelamin') == "L" || $pelanggan->jenis_kelamin == "L") selected @endif value="L">L</option>
                                    <option @if(old('jenis_kelamin') == "P" || $pelanggan->jenis_kelamin == "P") selected @endif value="P">P</option>
                                </select>
                            </div>
                            @error('jenis_kelamin')
                                <div class="col-sm-2"></div>
